...
<entity
  ...
  platform="false"
  loadable="false"
  table="${coverage.TableName}">
  <implementsEntity
    name="Coverage"/>
  <implementsInterface
    iface="gw.api.domain.CoverageAdapter"
    impl="${coverage.LOBPackageName}.${coverage.CoverageAdapterImplName}"/>
  <implementsInterface
    iface="gw.api.logicalmatch.EffDatedLogicalMatcher"
    impl="${coverage.LOBPackageName}.${coverage.CoverageMatcherImplName}"/>
${EntityColumn.renderToString(coverage.FkFieldToCoverable)}
  <column
    name="BooleanTerm1"
    type="bit"
