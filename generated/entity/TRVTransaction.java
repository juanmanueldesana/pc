...
/**
 * TRVTransaction
 * A transaction for the Seguro de Viaje line
 */
...
@gw.entity.EntityName(value = "TRVTransaction")
public class TRVTransaction extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Transaction {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.TRVTransaction, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.TRVTransaction, entity.PolicyPeriod>("entity.TRVTransaction");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> TRVCOST_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "TRVCost");
  ...
  private com.guidewire._generated.entity.TRVTransactionInternal _internal;
   ...
   */
  public TRVTransaction(entity.PolicyPeriod branch)  {
   ...
   */
  public TRVTransaction(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected TRVTransaction(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.TRVTransactionInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.TRVTransactionInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.TRVTransaction clone() {
    return (entity.TRVTransaction)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.TRVTransaction getBasedOn() {
    return (entity.TRVTransaction)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.TRVTransaction getBasedOnValue() {
    return (entity.TRVTransaction)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  public entity.TRVTransaction getFixed() {
    return (entity.TRVTransaction)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.TRVTransaction getSlice(java.util.Date sliceDate) {
    return (entity.TRVTransaction)getSliceUntyped(sliceDate);
  }
  ...
  public entity.TRVCost getTRVCost() {
    return (entity.TRVCost)__getInternalInterface().getFieldValue(TRVCOST_PROP.get());
  }
  
  public entity.TRVTransaction getUnsliced() {
    return (entity.TRVTransaction)getUnslicedUntyped();
  }
  ...
  public entity.windowed.TRVTransactionVersionList getVersionList() {
    return (entity.windowed.TRVTransactionVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.TRVTransaction value) {
   ...
   */
  private void setFixed(entity.TRVTransaction value) {
  ...
  public void setTRVCost(entity.TRVCost value) {
    __getInternalInterface().setFieldValue(TRVCOST_PROP.get(), value);
  }
  ...
  public entity.TRVTransaction split(java.util.Date splitDate) {
    return (entity.TRVTransaction)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.TRVTransactionInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.TRVTransaction.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getTRVCostID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(TRVCOST_PROP.get());
    }
    ...
    public void setTRVCostID(gw.pl.persistence.core.Key value) {
      setFieldValue(TRVCOST_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.financials.TransactionAdapter", "gw.lob.trv.financials.TRVTransactionAdapter");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.TRVTransaction.class, config);
    com.guidewire._generated.entity.TRVTransactionInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.TRVTransaction, com.guidewire._generated.entity.TRVTransactionInternal>() {
      public java.lang.Object getImplementation(entity.TRVTransaction bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.TRVTransactionInternal getInternalInterface(entity.TRVTransaction bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.TRVTransaction newEmptyInstance() {
        return new entity.TRVTransaction((java.lang.Void)null);
      }
