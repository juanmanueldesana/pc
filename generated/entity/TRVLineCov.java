...
/**
 * TRVLineCov
 * Coverages directly attached to Seguro de Viaje
 */
...
@gw.entity.EntityName(value = "TRVLineCov")
public class TRVLineCov extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Coverage, gw.api.logicalmatch.EffDatedLogicalMatcher {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.TRVLineCov, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.TRVLineCov, entity.PolicyPeriod>("entity.TRVLineCov");
  ...
  private com.guidewire._generated.entity.TRVLineCovInternal _internal;
   ...
   */
  protected TRVLineCov(entity.PolicyPeriod branch, java.lang.String param_PatternCode)  {
   ...
   */
  protected TRVLineCov(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate, java.lang.String param_PatternCode)  {
    this((java.lang.Void)null);
  ...
  protected TRVLineCov(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.TRVLineCovInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.TRVLineCovInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.TRVLineCov clone() {
    return (entity.TRVLineCov)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.TRVLineCov getBasedOn() {
    return (entity.TRVLineCov)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.TRVLineCov getBasedOnValue() {
    return (entity.TRVLineCov)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.TRVLineCov getFixed() {
    return (entity.TRVLineCov)__getInternalInterface().getFieldValue(FIXED_PROP.get());
  }
  ...
  public entity.TRVLineCov getSlice(java.util.Date sliceDate) {
    return (entity.TRVLineCov)getSliceUntyped(sliceDate);
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.TRVLineCov getSubtype() {
    return (typekey.TRVLineCov)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
  ...
  public entity.TRVLineCov getUnsliced() {
    return (entity.TRVLineCov)getUnslicedUntyped();
  }
  ...
  public entity.windowed.TRVLineCovVersionList getVersionList() {
    return (entity.windowed.TRVLineCovVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.TRVLineCov value) {
   ...
   */
  private void setFixed(entity.TRVLineCov value) {
   ...
   */
  private void setSubtype(typekey.TRVLineCov value) {
  ...
  public entity.TRVLineCov split(java.util.Date splitDate) {
    return (entity.TRVLineCov)splitUntyped(splitDate);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.TRVLineCovInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.TRVLineCov.this.__getDelegateManager();
    }
     ...
     * Sets the value of the BasedOnValue field.
     */
    public void setBasedOnValue(entity.TRVLineCov value) {
      __getInternalInterface().setFieldValue(BASEDONVALUE_PROP.get(), value);
    }
     ...
     * Sets the value of the Fixed field.
     */
    public void setFixed(entity.TRVLineCov value) {
      __getInternalInterface().setFieldValue(FIXED_PROP.get(), value);
    }
     ...
     * Sets the value of the Subtype field.
     */
    public void setSubtype(typekey.TRVLineCov value) {
      __getInternalInterface().setFieldValue(SUBTYPE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.domain.ClauseAbstractMethods", "gw.lob.trv.TRVLineCovCoverageAdapter");
    config.put("gw.api.domain.ClauseAdapter", "gw.lob.trv.TRVLineCovCoverageAdapter");
    config.put("gw.api.domain.CoverageAbstractDomainMethods", "gw.lob.trv.TRVLineCovCoverageAdapter");
    config.put("gw.api.domain.CoverageAdapter", "gw.lob.trv.TRVLineCovCoverageAdapter");
    config.put("gw.api.logicalmatch.EffDatedLogicalMatcher", "gw.lob.trv.TRVLineCovMatcher");
    config.put("gw.api.logicalmatch.LogicalMatcher", "gw.lob.trv.TRVLineCovMatcher");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.TRVLineCov.class, config);
    com.guidewire._generated.entity.TRVLineCovInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.TRVLineCov, com.guidewire._generated.entity.TRVLineCovInternal>() {
      public java.lang.Object getImplementation(entity.TRVLineCov bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.TRVLineCovInternal getInternalInterface(entity.TRVLineCov bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.TRVLineCov newEmptyInstance() {
        return new entity.TRVLineCov((java.lang.Void)null);
      }
