 ...
 * Traveler
 */
@javax.annotation.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "Traveler.eti;Traveler.eix;Traveler.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "Traveler")
public class Traveler extends entity.AccountContactRole {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.Traveler> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.Traveler>("entity.Traveler");
   ...
   */
  public Traveler(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected Traveler(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.TravelerInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.TravelerInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.TravelerInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.TravelerInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.Traveler.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.Traveler.class, config);
    com.guidewire._generated.entity.TravelerInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.Traveler, com.guidewire._generated.entity.TravelerInternal>() {
      public java.lang.Object getImplementation(entity.Traveler bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.TravelerInternal getInternalInterface(entity.Traveler bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.Traveler newEmptyInstance() {
        return new entity.Traveler((java.lang.Void)null);
      }
