...
/**
 * TRVCost
 * A unit of premium or other cost (taxes, fees, etc.) for the Seguro de Viaje line.
 */
...
public abstract class TRVCost extends com.guidewire.pl.persistence.code.BeanBase implements entity.EffDated, entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.TRVCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.TRVCost, entity.PolicyPeriod>("entity.TRVCost");
  ...
  private com.guidewire._generated.entity.TRVCostInternal _internal;
  ...
  protected TRVCost(java.lang.Void ignored)  {
    
  }
  
  protected abstract com.guidewire._generated.entity.TRVCostInternal __createInternalInterface();
  ...
  protected com.guidewire._generated.entity.TRVCostInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.TRVCost clone() {
    return (entity.TRVCost)__getInternalInterface().cloneUntyped();
  }
  ...
  public entity.TRVCost getBasedOn() {
    return (entity.TRVCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.TRVCost getSlice(java.util.Date sliceDate) {
    return (entity.TRVCost)getSliceUntyped(sliceDate);
  }
  ...
  public entity.TRVCost getUnsliced() {
    return (entity.TRVCost)getUnslicedUntyped();
  }
  ...
  public entity.windowed.TRVCostVersionList getVersionList() {
    return (entity.windowed.TRVCostVersionList)getVersionListUntyped();
  }
   ...
   */
  private void setBasedOnValue(entity.TRVCost value) {
   ...
   */
  private void setFixed(entity.TRVCost value) {
   ...
   */
  private void setSubtype(typekey.TRVCost value) {
   ...
   */
  private void setTransactions(entity.TRVTransaction[] value) {
  ...
  public entity.TRVCost split(java.util.Date splitDate) {
    return (entity.TRVCost)splitUntyped(splitDate);
  }
  ...
  static {
    com.guidewire._generated.entity.TRVCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.EntityFriendAccess<entity.TRVCost, com.guidewire._generated.entity.TRVCostInternal>() {
      public java.lang.Object getImplementation(entity.TRVCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.TRVCostInternal getInternalInterface(entity.TRVCost bean) {
        if(bean == null) {
          return null;
        };
