...
@gw.entity.EntityName(value = "PolicyTraveler")
public class PolicyTraveler extends entity.PolicyContactRole {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.PolicyTraveler, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.PolicyTraveler, entity.PolicyPeriod>("entity.PolicyTraveler");
   ...
   */
  public PolicyTraveler(entity.PolicyPeriod branch)  {
   ...
   */
  public PolicyTraveler(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected PolicyTraveler(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PolicyTravelerInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PolicyTravelerInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PolicyTravelerInternal)super.__getInternalInterface();
  }
  
  public entity.PolicyTraveler clone() {
    return (entity.PolicyTraveler)__getInternalInterface().cloneUntyped();
  }
  
  public entity.PolicyTraveler getBasedOn() {
    return (entity.PolicyTraveler)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.PolicyTraveler getSlice(java.util.Date sliceDate) {
    return (entity.PolicyTraveler)getSliceUntyped(sliceDate);
  }
  ...
  public entity.PolicyTraveler getUnsliced() {
    return (entity.PolicyTraveler)getUnslicedUntyped();
  }
  
  public entity.windowed.PolicyTravelerVersionList getVersionList() {
    return (entity.windowed.PolicyTravelerVersionList)getVersionListUntyped();
  }
  ...
  public entity.PolicyTraveler split(java.util.Date splitDate) {
    return (entity.PolicyTraveler)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PolicyTravelerInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PolicyTraveler.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PolicyTraveler.class, config);
    com.guidewire._generated.entity.PolicyTravelerInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PolicyTraveler, com.guidewire._generated.entity.PolicyTravelerInternal>() {
      public java.lang.Object getImplementation(entity.PolicyTraveler bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PolicyTravelerInternal getInternalInterface(entity.PolicyTraveler bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PolicyTraveler newEmptyInstance() {
        return new entity.PolicyTraveler((java.lang.Void)null);
      }
