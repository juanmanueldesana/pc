...
@gw.entity.EntityName(value = "TRVCoverCost")
public class TRVCoverCost extends entity.TRVCost implements entity.Cost {
  public static final gw.pl.persistence.type.EffDatedEntityTypeReference<entity.TRVCoverCost, entity.PolicyPeriod> TYPE = new com.guidewire.commons.metadata.types.EffDatedEntityIntrinsicTypeReference<entity.TRVCoverCost, entity.PolicyPeriod>("entity.TRVCoverCost");
   ...
   */
  public TRVCoverCost(entity.PolicyPeriod branch)  {
   ...
   */
  public TRVCoverCost(entity.PolicyPeriod branch, java.util.Date effectiveDate, java.util.Date expirationDate)  {
    this((java.lang.Void)null);
  ...
  protected TRVCoverCost(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.TRVCoverCostInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.TRVCoverCostInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.TRVCoverCostInternal)super.__getInternalInterface();
  }
  
  public entity.TRVCoverCost clone() {
    return (entity.TRVCoverCost)__getInternalInterface().cloneUntyped();
  }
  
  public entity.TRVCoverCost getBasedOn() {
    return (entity.TRVCoverCost)__getInternalInterface().getBasedOnUntyped();
  }
  ...
  public entity.TRVCoverCost getSlice(java.util.Date sliceDate) {
    return (entity.TRVCoverCost)getSliceUntyped(sliceDate);
  }
  
  public entity.TRVCoverCost getUnsliced() {
    return (entity.TRVCoverCost)getUnslicedUntyped();
  }
  
  public entity.windowed.TRVCoverCostVersionList getVersionList() {
    return (entity.windowed.TRVCoverCostVersionList)getVersionListUntyped();
  }
  
  public entity.TRVCoverCost split(java.util.Date splitDate) {
    return (entity.TRVCoverCost)splitUntyped(splitDate);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.TRVCoverCostInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.TRVCoverCost.this.__getDelegateManager();
    }
    ...
    public entity.TRVCost getBasedOnValue() {
      return (entity.TRVCost)__getInternalInterface().getFieldValue(BASEDONVALUE_PROP.get());
    }
    ...
    public entity.TRVCost getFixed() {
      return (entity.TRVCost)__getInternalInterface().getFieldValue(FIXED_PROP.get());
    }
    ...
    public typekey.TRVCost getSubtype() {
      return (typekey.TRVCost)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
    }
    ...
    public entity.TRVTransaction[] getTransactions() {
      return (entity.TRVTransaction[])__getInternalInterface().getFieldValue(TRANSACTIONS_PROP.get());
    }
  ...
  static {
    ...
    config.put("gw.api.domain.financials.CostAdapter", "gw.lob.trv.financials.TRVCostAdapter");
    config.put("gw.lob.trv.financials.TRVCostMethods", "gw.lob.trv.financials.TRVCostMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.TRVCoverCost.class, config);
    com.guidewire._generated.entity.TRVCoverCostInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.TRVCoverCost, com.guidewire._generated.entity.TRVCoverCostInternal>() {
      public java.lang.Object getImplementation(entity.TRVCoverCost bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.TRVCoverCostInternal getInternalInterface(entity.TRVCoverCost bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.TRVCoverCost newEmptyInstance() {
        return new entity.TRVCoverCost((java.lang.Void)null);
      }
