...
class LineWizardStepSet_InlandMarineExpressions {
  ...
  public static class LineWizardStepSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function value_25 () : typekey.IMCoveragePart[] {
  ...
  public static class impartstepExpressionsImpl extends LineWizardStepSetExpressionsImpl {
    ...
    // 'beforeSave' attribute on JobWizardStep (id=impartstep) at LineWizardStepSet.InlandMarine.pcf: line 47, column 77
    ...
    // 'mode' attribute on JobWizardStep (id=impartstep) at LineWizardStepSet.InlandMarine.pcf: line 47, column 77
    function mode_12 () : java.lang.Object {
      return imcoveragepart.Code
    }
    
    // 'onEnter' attribute on JobWizardStep (id=impartstep) at LineWizardStepSet.InlandMarine.pcf: line 47, column 77
    ...
    // 'onExit' attribute on JobWizardStep (id=impartstep) at LineWizardStepSet.InlandMarine.pcf: line 47, column 77
    function onExit_14 () : void {
      jobWizardHelper.reloadPolicyPeriodIfAsyncQuoteComplete(policyPeriod)
    }
    
    // 'save' attribute on JobWizardStep (id=impartstep) at LineWizardStepSet.InlandMarine.pcf: line 47, column 77
    function save_15 () : java.lang.Boolean {
      return openForEdit
    }
    
    // 'screen' attribute on JobWizardStep (id=impartstep) at LineWizardStepSet.InlandMarine.pcf: line 47, column 77
    function screen_onEnter_16 (def :  pcf.IMPartScreen_ContractorsEquipPart) : void {
      def.onEnter(job, policyPeriod, openForEdit, jobWizardHelper)
    }
    
    // 'screen' attribute on JobWizardStep (id=impartstep) at LineWizardStepSet.InlandMarine.pcf: line 47, column 77
    function screen_onEnter_18 (def :  pcf.IMPartScreen_IMAccountsRecPart) : void {
      def.onEnter(job, policyPeriod, openForEdit, jobWizardHelper)
    }
    
    // 'screen' attribute on JobWizardStep (id=impartstep) at LineWizardStepSet.InlandMarine.pcf: line 47, column 77
    function screen_onEnter_20 (def :  pcf.IMPartScreen_IMSignPart) : void {
      def.onEnter(job, policyPeriod, openForEdit, jobWizardHelper)
    }
    
    // 'screen' attribute on JobWizardStep (id=impartstep) at LineWizardStepSet.InlandMarine.pcf: line 47, column 77
    function screen_onEnter_22 (def :  pcf.IMPartScreen_default) : void {
      def.onEnter(job, policyPeriod, openForEdit, jobWizardHelper)
    }
    
    // 'screen' attribute on JobWizardStep (id=impartstep) at LineWizardStepSet.InlandMarine.pcf: line 47, column 77
    function screen_refreshVariables_17 (def :  pcf.IMPartScreen_ContractorsEquipPart) : void {
      def.refreshVariables(job, policyPeriod, openForEdit, jobWizardHelper)
    }
    
    // 'screen' attribute on JobWizardStep (id=impartstep) at LineWizardStepSet.InlandMarine.pcf: line 47, column 77
    function screen_refreshVariables_19 (def :  pcf.IMPartScreen_IMAccountsRecPart) : void {
      def.refreshVariables(job, policyPeriod, openForEdit, jobWizardHelper)
    }
    
    // 'screen' attribute on JobWizardStep (id=impartstep) at LineWizardStepSet.InlandMarine.pcf: line 47, column 77
    function screen_refreshVariables_21 (def :  pcf.IMPartScreen_IMSignPart) : void {
      def.refreshVariables(job, policyPeriod, openForEdit, jobWizardHelper)
    }
    
    // 'screen' attribute on JobWizardStep (id=impartstep) at LineWizardStepSet.InlandMarine.pcf: line 47, column 77
    function screen_refreshVariables_23 (def :  pcf.IMPartScreen_default) : void {
      def.refreshVariables(job, policyPeriod, openForEdit, jobWizardHelper)
    }
    
    // 'title' attribute on JobWizardStep (id=impartstep) at LineWizardStepSet.InlandMarine.pcf: line 47, column 77
    function title_24 () : java.lang.String {
      return imcoveragepart.DisplayName
    }
    
    // 'visible' attribute on JobWizardStep (id=impartstep) at LineWizardStepSet.InlandMarine.pcf: line 47, column 77
