...
class TRVLineStandardCoveragesDVExpressions {
  @javax.annotation.Generated("config/web/pcf/line/trv/policy/TRVLineStandardCoveragesDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class IteratorEntryExpressionsImpl extends TRVLineStandardCoveragesDVExpressionsImpl {
    ...
    // 'def' attribute on InputSetRef at TRVLineStandardCoveragesDV.pcf: line 34, column 44
    function def_onEnter_11 (def :  pcf.CoverageInputSet_CPBPPCov) : void {
      def.onEnter(coveragePattern, line, openForEdit)
    }
    ...
    function def_refreshVariables_10 (def :  pcf.CoverageInputSet_BOPToolsSchedCov) : void {
      def.refreshVariables(coveragePattern, line, openForEdit)
    }
    ...
    // 'mode' attribute on InputSetRef at TRVLineStandardCoveragesDV.pcf: line 34, column 44
  ...
  @javax.annotation.Generated("config/web/pcf/line/trv/policy/TRVLineStandardCoveragesDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class TRVLineStandardCoveragesDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    public construct(widget :  Object) {
      super(widget, 0)
    }
    ...
    // 'initialValue' attribute on Variable at TRVLineStandardCoveragesDV.pcf: line 16, column 52
    function initialValue_0 () : gw.api.productmodel.CoverageCategory {
      return line.Pattern.getCoverageCategoryByPublicId("TRVLineStndGrp")
    }
    
    // 'initialValue' attribute on Variable at TRVLineStandardCoveragesDV.pcf: line 21, column 51
    function initialValue_1 () : gw.api.productmodel.ClausePattern[] {
      return covCat.coveragePatternsForEntity(TRVLine).whereSelectedOrAvailable(line, openForEdit)
    }
    
    // 'sortBy' attribute on IteratorSort at TRVLineStandardCoveragesDV.pcf: line 31, column 26
    function sortBy_2 (coveragePattern :  gw.api.productmodel.ClausePattern) : java.lang.Object {
      return coveragePattern.Priority
    }
    
    // 'value' attribute on InputIterator (id=covIterator) at TRVLineStandardCoveragesDV.pcf: line 28, column 57
    function value_34 () : gw.api.productmodel.ClausePattern[] {
      return covPatterns
    }
    
    property get covCat () : gw.api.productmodel.CoverageCategory {
      return getVariableValue("covCat", 0) as gw.api.productmodel.CoverageCategory
    }
    
    property set covCat ($arg :  gw.api.productmodel.CoverageCategory) {
      setVariableValue("covCat", 0, $arg)
    }
