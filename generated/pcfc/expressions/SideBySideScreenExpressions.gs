...
class SideBySideScreenExpressions {
  ...
  public static class SideBySideScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at SideBySideScreen.pcf: line 43, column 44
    function def_onEnter_11 (def :  pcf.SideBySideTableLayoutDV) : void {
      def.onEnter(jobWizHelper, sideHelper)
    }
    
    // 'def' attribute on PanelRef (id=WarningMessages) at SideBySideScreen.pcf: line 37, column 31
    ...
    // 'def' attribute on PanelRef at SideBySideScreen.pcf: line 39, column 64
    ...
    // 'initialValue' attribute on Variable at SideBySideScreen.pcf: line 17, column 23
    function initialValue_0 () : boolean {
      return gw.lob.common.SideBySideUtil.hasOOSorPreemption(basePeriod.Job)
    }
    
    // 'initialValue' attribute on Variable at SideBySideScreen.pcf: line 22, column 30
    function initialValue_1 () : PolicyPeriod[] {
      return gw.lob.common.SideBySideUtil.getSideBySidePeriods(basePeriod)
    }
    
    // 'initialValue' attribute on Variable at SideBySideScreen.pcf: line 27, column 56
    function initialValue_2 () : gw.pcf.sidebyside.SideBySideScreenHelper {
      return new gw.pcf.sidebyside.SideBySideScreenHelper(jobWizHelper, periods)
    }
    
    // 'toolbarButtonSet' attribute on ToolbarButtonSetRef at SideBySideScreen.pcf: line 31, column 104
    ...
    // 'visible' attribute on PanelRef at SideBySideScreen.pcf: line 43, column 44
    function visible_10 () : java.lang.Boolean {
      return not hideInitialSideBySide
    }
    
    // 'visible' attribute on PanelSet at SideBySideScreen.pcf: line 34, column 39
