...
class TeamSummaryExpressions {
  ...
  public static class TeamSummaryScreenExpressionsImpl extends TeamSummaryExpressionsImpl {
    ...
    // 'def' attribute on PanelRef at TeamSummary.pcf: line 25, column 53
    function def_onEnter_8 (def :  pcf.TeamSummaryLV) : void {
      def.onEnter(teamModel, statsType)
    }
    
    // 'def' attribute on PanelRef at TeamSummary.pcf: line 25, column 53
    function def_refreshVariables_9 (def :  pcf.TeamSummaryLV) : void {
      def.refreshVariables(teamModel, statsType)
    }
    
    // 'value' attribute on ToolbarRangeInput (id=TeamSummaryStatsType_Input) at TeamSummary.pcf: line 37, column 49
    ...
    // 'valueRange' attribute on ToolbarRangeInput (id=TeamSummaryStatsType_Input) at TeamSummary.pcf: line 37, column 49
