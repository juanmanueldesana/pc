...
class PolicyFile_Forms_TRVExpressions {
  @javax.annotation.Generated("config/web/pcf/line/trv/policyfile/PolicyFile_Forms_TRV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class PolicyFile_Forms_TRVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'afterEnter' attribute on Page (id=PolicyFile_Forms_TRV) at PolicyFile_Forms_TRV.pcf: line 10, column 62
    function afterEnter_2 () : void {
      gw.api.web.PebblesUtil.addWebMessages(CurrentLocation, policyPeriod.PolicyFileMessages)
    }
    
    // 'canVisit' attribute on Page (id=PolicyFile_Forms_TRV) at PolicyFile_Forms_TRV.pcf: line 10, column 62
    ...
    // 'def' attribute on ScreenRef at PolicyFile_Forms_TRV.pcf: line 20, column 84
    function def_onEnter_0 (def :  pcf.PolicyFile_PolicyLine_FormsScreen) : void {
      def.onEnter(policyPeriod, policyPeriod.TRVLine)
    }
    
    // 'def' attribute on ScreenRef at PolicyFile_Forms_TRV.pcf: line 20, column 84
    function def_refreshVariables_1 (def :  pcf.PolicyFile_PolicyLine_FormsScreen) : void {
      def.refreshVariables(policyPeriod, policyPeriod.TRVLine)
    }
    
    // 'parent' attribute on Page (id=PolicyFile_Forms_TRV) at PolicyFile_Forms_TRV.pcf: line 10, column 62
    ...
    override property get CurrentLocation () : pcf.PolicyFile_Forms_TRV {
      return super.CurrentLocation as pcf.PolicyFile_Forms_TRV
    }
