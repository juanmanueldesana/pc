...
class CopyPolicyDataSearchScreenExpressions {
  ...
  public static class PolicySearchDVExpressionsImpl extends SearchPanelExpressionsImpl {
    ...
    function def_onEnter_102 (def :  pcf.SearchAndResetInputSet) : void {
      def.onEnter()
    }
    ...
    // 'def' attribute on InputSetRef at CopyPolicyDataSearchScreen.pcf: line 139, column 45
    function def_refreshVariables_103 (def :  pcf.SearchAndResetInputSet) : void {
    ...
    // 'value' attribute on DateCriterionChoiceInput (id=DateRangeForJobSearch_Input) at CopyPolicyDataSearchScreen.pcf: line 128, column 31
    function value_74 () : java.lang.Object {
      return searchCriteria.DateCriteria.DateSearchType
    }
    ...
    // 'value' attribute on DateCriterionChoiceInput (id=DateRangeForJobSearch_Input) at CopyPolicyDataSearchScreen.pcf: line 128, column 31
    function value_91 () : entity.DateCriteria {
      return searchCriteria.DateCriteria
    }
  ...
  public static class SearchPanelExpressionsImpl extends CopyPolicyDataSearchScreenExpressionsImpl {
    ...
    function def_onEnter_104 (def :  pcf.CopyPolicyDataSearch_ResultsLV_Policy) : void {
      def.onEnter(searchResult, destPeriod)
    }
    
    // 'def' attribute on PanelRef at CopyPolicyDataSearchScreen.pcf: line 144, column 45
    function def_onEnter_106 (def :  pcf.CopyPolicyDataSearch_ResultsLV_PolicyChange) : void {
      def.onEnter(searchResult, destPeriod)
    }
    
    // 'def' attribute on PanelRef at CopyPolicyDataSearchScreen.pcf: line 144, column 45
    function def_onEnter_108 (def :  pcf.CopyPolicyDataSearch_ResultsLV_Renewal) : void {
      def.onEnter(searchResult, destPeriod)
    }
    
    // 'def' attribute on PanelRef at CopyPolicyDataSearchScreen.pcf: line 144, column 45
    function def_onEnter_110 (def :  pcf.CopyPolicyDataSearch_ResultsLV_Rewrite) : void {
      def.onEnter(searchResult, destPeriod)
    }
    
    // 'def' attribute on PanelRef at CopyPolicyDataSearchScreen.pcf: line 144, column 45
    function def_onEnter_112 (def :  pcf.CopyPolicyDataSearch_ResultsLV_RewriteNewAccount) : void {
      def.onEnter(searchResult, destPeriod)
    }
    
    // 'def' attribute on PanelRef at CopyPolicyDataSearchScreen.pcf: line 144, column 45
    function def_onEnter_114 (def :  pcf.CopyPolicyDataSearch_ResultsLV_Submission) : void {
      def.onEnter(searchResult, destPeriod)
    }
    
    // 'def' attribute on PanelRef at CopyPolicyDataSearchScreen.pcf: line 144, column 45
    function def_refreshVariables_105 (def :  pcf.CopyPolicyDataSearch_ResultsLV_Policy) : void {
      def.refreshVariables(searchResult, destPeriod)
    }
    
    // 'def' attribute on PanelRef at CopyPolicyDataSearchScreen.pcf: line 144, column 45
    function def_refreshVariables_107 (def :  pcf.CopyPolicyDataSearch_ResultsLV_PolicyChange) : void {
      def.refreshVariables(searchResult, destPeriod)
    }
    
    // 'def' attribute on PanelRef at CopyPolicyDataSearchScreen.pcf: line 144, column 45
    function def_refreshVariables_109 (def :  pcf.CopyPolicyDataSearch_ResultsLV_Renewal) : void {
      def.refreshVariables(searchResult, destPeriod)
    }
    
    // 'def' attribute on PanelRef at CopyPolicyDataSearchScreen.pcf: line 144, column 45
    function def_refreshVariables_111 (def :  pcf.CopyPolicyDataSearch_ResultsLV_Rewrite) : void {
      def.refreshVariables(searchResult, destPeriod)
    }
    
    // 'def' attribute on PanelRef at CopyPolicyDataSearchScreen.pcf: line 144, column 45
    function def_refreshVariables_113 (def :  pcf.CopyPolicyDataSearch_ResultsLV_RewriteNewAccount) : void {
      def.refreshVariables(searchResult, destPeriod)
    }
    
    // 'def' attribute on PanelRef at CopyPolicyDataSearchScreen.pcf: line 144, column 45
    function def_refreshVariables_115 (def :  pcf.CopyPolicyDataSearch_ResultsLV_Submission) : void {
      def.refreshVariables(searchResult, destPeriod)
    }
    
    // 'maxSearchResults' attribute on SearchPanel at CopyPolicyDataSearchScreen.pcf: line 21, column 87
    function maxSearchResults_117 () : java.lang.Object {
