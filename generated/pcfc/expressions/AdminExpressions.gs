...
class AdminExpressions {
  ...
  public static class AdminExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    static function canVisit_76 (affinityGroup :  AffinityGroup, group :  Group, org :  Organization) : java.lang.Boolean {
    ...
    static function firstVisitableChildDestinationMethod_83 (affinityGroup :  AffinityGroup, group :  Group, org :  Organization) : pcf.api.Destination {
    ...
    function menuActions_onEnter_77 (def :  pcf.AdminMenuActions) : void {
      def.onEnter()
    }
    
    // 'menuActions' attribute on LocationGroup (id=Admin) at Admin.pcf: line 11, column 71
    function menuActions_refreshVariables_78 (def :  pcf.AdminMenuActions) : void {
      def.refreshVariables()
    }
    
    // 'menuTree' attribute on LocationGroup (id=Admin) at Admin.pcf: line 11, column 71
    function menuTree_onEnter_79 (def :  pcf.AdminMenuTree) : void {
      def.onEnter(treeModel, org, group)
    }
    
    // 'menuTree' attribute on LocationGroup (id=Admin) at Admin.pcf: line 11, column 71
    function menuTree_refreshVariables_80 (def :  pcf.AdminMenuTree) : void {
      def.refreshVariables(treeModel, org, group)
    }
    
    // 'tabBar' attribute on LocationGroup (id=Admin) at Admin.pcf: line 11, column 71
    function tabBar_onEnter_81 (def :  pcf.TabBar) : void {
      def.onEnter()
    }
    
    // 'tabBar' attribute on LocationGroup (id=Admin) at Admin.pcf: line 11, column 71
    function tabBar_refreshVariables_82 (def :  pcf.TabBar) : void {
      def.refreshVariables()
    }
