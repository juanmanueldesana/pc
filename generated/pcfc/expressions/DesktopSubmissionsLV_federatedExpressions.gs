...
class DesktopSubmissionsLV_federatedExpressions {
  ...
  public static class DesktopSubmissionsLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function filter_2 () : gw.api.filters.IFilter {
      return gw.api.web.desktop.data.submission.SubmissionDataFilters.openIssuance()
    }
    
    // 'filters' attribute on ToolbarFilterOptionGroup at DesktopSubmissionsLV.federated.pcf: line 24, column 97
    function filters_1 () : gw.api.filters.IFilter[] {
      return gw.api.web.desktop.data.submission.SubmissionDataFilters.activityFilters()
    }
    ...
    function filters_3 () : gw.api.filters.IFilter[] {
      return gw.api.web.desktop.data.submission.SubmissionDataFilters.producerFilters()
    }
    ...
    // 'value' attribute on TextCell (id=Insured_Cell) at DesktopSubmissionsLV.federated.pcf: line 42, column 50
  ...
  public static class IteratorEntryExpressionsImpl extends DesktopSubmissionsLVExpressionsImpl {
    ...
    // 'action' attribute on TextCell (id=Insured_Cell) at DesktopSubmissionsLV.federated.pcf: line 42, column 50
    ...
    // 'available' attribute on TextCell (id=Insured_Cell) at DesktopSubmissionsLV.federated.pcf: line 42, column 50
