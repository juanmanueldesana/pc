import { GwDomNode, GwEventType, GwMap, HTMLTextInputElement } from "../../types/gwTypes";
...
export declare class GwDateValue extends GwInitializableSystem {
     ...
     */
    showDatePickerOnFocus(el: HTMLInputElement, args: GwMap, event: GwEventType): void;
    /**
    ...
    setValue(dateWidgetNode: GwDomNode, dateValue: string): boolean;
