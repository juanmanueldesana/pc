import { GwClassIdTagOrNode, GwDomNode, GwPanelScope } from "../types/gwTypes";
/**
...
export declare class GwFocus {
    ...
    handleFocusForClickOnNonClickableArea(target: GwDomNode): void;
    /**
     * @public
