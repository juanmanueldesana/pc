import { GwDomNode, GwEventType, GwInputElement, GwMap, GwValueAndCursorPos, HTMLTextInputElement } from "../../types/gwTypes";
...
export declare class GwInputSystems extends GwRegisteredSystem {
    ...
    /**
     * Takes a picker div and attempts to to align it left | right | above | below
     ...
     */
    preventPickerBeingOffscreen(parent: GwDomNode, input: GwInputElement, pickerDiv: GwDomNode, alignRight?: boolean, placeAbove?: boolean, forceVPos?: null | "above" | "below", restrictToViewableScreen?: boolean): boolean;
    ...
    inputEventNotifySystems(el: HTMLTextInputElement, args: GwMap, e: GwEventType): void;
    pasteEventNotifySystems(el: HTMLTextInputElement, args: GwMap, e: GwEventType): void;
    copyEventNotifySystems(el: HTMLTextInputElement, args: GwMap, e: GwEventType): void;
    notifySystemsOfInputValueChange(el: HTMLTextInputElement, ignoreSystem?: string | null, args?: GwMap, e?: GwEventType): void;
    private hasDateTimeMask(el);
    private clearElementWithInputMaskValue(el);
    private setValueOnElementWithInputMask(el, val, cursorPos?);
    /**
     ...
     */
    private handleUserInputRestrictionForInputsWithoutMasks(el, restrictedInput);
    private isValidChar(char, regex);
    /**
     * Fired for any input that has data-gw-input-mask.
     * Uses logic based on the contents of the input mask
     * @param el - an input element
     * @param args - not used
     * @param e - not used
     */
    valueChangedSoProcessInputMask(el: HTMLTextInputElement): void;
    /**
     * @private
     ...
     * @returns {*}
     */
    getValueWithMaskTrimmed(el: HTMLTextInputElement): string;
    /**
     *
     * @param {string} value
     ...
     */
    addGroupingSeparators(value: string, cursorIndex: number, userDeletedChar: boolean): GwValueAndCursorPos;
    /**
     ...
     * @param e
     */
    handleGroupingDecimalsAndMacros(el: HTMLTextInputElement): GwValueAndCursorPos;
}
