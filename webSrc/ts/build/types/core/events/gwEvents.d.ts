 ...
 */
import { GwDomNode, GwMap, GwPanelScope, GwContextNode, GwTypedMap, GwAction, GwInputElement, GwValueWidgetElement, GwPartialReloadDetails } from "../../types/gwTypes";
...
export declare class GwEvents extends GwOrderDependentInitializableSystem {
    ...
    private mouseDown;
    /**
     * The target that the mouse down is registered on. This allows us to run logic in the "click" event, to decide if we should
     * allow the click, and allow "post click" actions.
     * For instance, if a drag element is found on mouse down, then this mouseDownTarget is removed to prevent the click event logic
     * @type {null}
     */
    ...
    /**
     * Currently we only use mousedown for drag start
     * @param {MouseEvent} event
     */
    onGlobalMousedownEvent(event: MouseEvent): void;
    onGlobalDragEvent(event: MouseEvent): void;
    onGlobalMouseupEvent(event: MouseEvent): void;
    ...
    onGlobalClickEvent(event: MouseEvent): void;
    onGlobalDblclickEvent(event: MouseEvent): void;
    ...
    private dispatchSimulatedMouseEvent(event, simulatedMousEventType);
    onGlobalTouchstartEvent(event: TouchEvent): void;
    onGlobalTouchendEvent(event: TouchEvent): void;
    onGlobalTouchcancelEvent(event: TouchEvent): void;
    onGlobalTouchmoveEvent(event: TouchEvent): void;
    /**
     *
     ...
     * @returns {boolean}
     */
    isMultiPartInput(el: GwInputElement): boolean;
    ...
    private closeProblematicTemporyElementsDuringConfirmAndPrompt();
    /**
     * @private
