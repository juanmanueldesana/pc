...
class AgreementCoverageInputSet_surplusExpressions {
  ...
  public static class AgreementCoverageInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'onChange' attribute on PostOnChange at AgreementCoverageInputSet.surplus.pcf: line 25, column 45
    function onChange_1 () : void {
      surplusTreaty.setDefaultMaxRetention(); agreement.updateAmountOfCoverageCeded()
    }
    
    // 'onChange' attribute on PostOnChange at AgreementCoverageInputSet.surplus.pcf: line 49, column 45
    function onChange_13 () : void {
      surplusTreaty.setDefaultAttachmentPoint()
    }
    
    // 'onChange' attribute on PostOnChange at AgreementCoverageInputSet.surplus.pcf: line 61, column 45
    function onChange_19 () : void {
      agreement.updateAmountOfCoverageCeded()
    }
    
    // 'onChange' attribute on PostOnChange at AgreementCoverageInputSet.surplus.pcf: line 37, column 45
