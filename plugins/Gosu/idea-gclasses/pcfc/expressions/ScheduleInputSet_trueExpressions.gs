...
class ScheduleInputSet_trueExpressions {
  ...
  public static class IteratorEntry3ExpressionsImpl extends ListViewPanelExpressionsImpl {
    ...
    function value_34 () : gw.api.productmodel.SchedulePropertyInfo<java.lang.Object>[] {
  ...
  public static class IteratorEntry5ExpressionsImpl extends IteratorEntry3ExpressionsImpl {
    ...
    function def_onEnter_36 (def :  pcf.ScheduledItemCovTermInput_Direct) : void {
      def.onEnter(scheduledItem.getCovTerm(covTermPattern))
    }
    
    // 'def' attribute on ModalCellRef at ScheduleInputSet.true.pcf: line 113, column 53
    function def_onEnter_38 (def :  pcf.ScheduledItemCovTermInput_Option) : void {
      def.onEnter(scheduledItem.getCovTerm(covTermPattern))
    }
    
    // 'def' attribute on ModalCellRef at ScheduleInputSet.true.pcf: line 113, column 53
    function def_onEnter_40 (def :  pcf.ScheduledItemCovTermInput_Package) : void {
      def.onEnter(scheduledItem.getCovTerm(covTermPattern))
    }
    
    // 'def' attribute on ModalCellRef at ScheduleInputSet.true.pcf: line 113, column 53
    function def_onEnter_42 (def :  pcf.ScheduledItemCovTermInput_Typekey) : void {
      def.onEnter(scheduledItem.getCovTerm(covTermPattern))
    }
    
    // 'def' attribute on ModalCellRef at ScheduleInputSet.true.pcf: line 113, column 53
    function def_onEnter_44 (def :  pcf.ScheduledItemCovTermInput_bit) : void {
      def.onEnter(scheduledItem.getCovTerm(covTermPattern))
    }
    
    // 'def' attribute on ModalCellRef at ScheduleInputSet.true.pcf: line 113, column 53
    function def_onEnter_46 (def :  pcf.ScheduledItemCovTermInput_shorttext) : void {
      def.onEnter(scheduledItem.getCovTerm(covTermPattern))
    }
    
    // 'def' attribute on ModalCellRef at ScheduleInputSet.true.pcf: line 113, column 53
    function def_refreshVariables_37 (def :  pcf.ScheduledItemCovTermInput_Direct) : void {
      def.refreshVariables(scheduledItem.getCovTerm(covTermPattern))
    }
    
    // 'def' attribute on ModalCellRef at ScheduleInputSet.true.pcf: line 113, column 53
    function def_refreshVariables_39 (def :  pcf.ScheduledItemCovTermInput_Option) : void {
      def.refreshVariables(scheduledItem.getCovTerm(covTermPattern))
    }
    
    // 'def' attribute on ModalCellRef at ScheduleInputSet.true.pcf: line 113, column 53
    function def_refreshVariables_41 (def :  pcf.ScheduledItemCovTermInput_Package) : void {
      def.refreshVariables(scheduledItem.getCovTerm(covTermPattern))
    }
    
    // 'def' attribute on ModalCellRef at ScheduleInputSet.true.pcf: line 113, column 53
    function def_refreshVariables_43 (def :  pcf.ScheduledItemCovTermInput_Typekey) : void {
      def.refreshVariables(scheduledItem.getCovTerm(covTermPattern))
    }
    
    // 'def' attribute on ModalCellRef at ScheduleInputSet.true.pcf: line 113, column 53
    function def_refreshVariables_45 (def :  pcf.ScheduledItemCovTermInput_bit) : void {
      def.refreshVariables(scheduledItem.getCovTerm(covTermPattern))
    }
    
    // 'def' attribute on ModalCellRef at ScheduleInputSet.true.pcf: line 113, column 53
    function def_refreshVariables_47 (def :  pcf.ScheduledItemCovTermInput_shorttext) : void {
      def.refreshVariables(scheduledItem.getCovTerm(covTermPattern))
    }
