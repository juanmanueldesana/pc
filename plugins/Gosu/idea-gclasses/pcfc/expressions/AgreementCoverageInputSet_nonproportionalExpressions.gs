...
class AgreementCoverageInputSet_nonproportionalExpressions {
  ...
  public static class AgreementCoverageInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'onChange' attribute on PostOnChange at AgreementCoverageInputSet.nonproportional.pcf: line 25, column 45
    function onChange_1 () : void {
      agreement.updateAmountOfCoverageCeded()
    }
    
    // 'onChange' attribute on PostOnChange at AgreementCoverageInputSet.nonproportional.pcf: line 43, column 45
    function onChange_11 () : void {
      agreement.updateAmountOfCoverageCeded()
    }
    
    // 'onChange' attribute on PostOnChange at AgreementCoverageInputSet.nonproportional.pcf: line 60, column 45
