...
class QuickSubmissionWizardExpressions {
  ...
  public static class QuickSubmissionWizardExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function acceleratedMenuActions_onEnter_18 (def :  pcf.MultiQuoteAcceleratedMenuActions) : void {
      def.onEnter(submission, policyPeriod, jobWizardHelper)
    }
    
    // 'acceleratedMenuActions' attribute on JobWizard (id=QuickSubmissionWizard) at QuickSubmissionWizard.pcf: line 22, column 90
    function acceleratedMenuActions_refreshVariables_19 (def :  pcf.MultiQuoteAcceleratedMenuActions) : void {
    ...
    static function canVisit_21 (policyPeriod :  PolicyPeriod, submission :  Submission) : java.lang.Boolean {
      return perm.Submission.view(submission)
    }
    
    // 'def' attribute on WizardStepSetRef at QuickSubmissionWizard.pcf: line 77, column 77
    function def_onEnter_16 (def :  pcf.JobWizardToolsMenuWizardStepSet) : void {
      def.onEnter(jobWizardHelper, policyPeriod)
    }
    
    // 'def' attribute on WizardStepSetRef at QuickSubmissionWizard.pcf: line 67, column 29
    function def_onEnter_7 (def :  pcf.LineQuickWizardStepSet_PersonalAuto) : void {
      def.onEnter(job, policyPeriod, jobWizardHelper, openForEdit)
    }
    
    // 'def' attribute on WizardStepSetRef at QuickSubmissionWizard.pcf: line 67, column 29
    function def_onEnter_9 (def :  pcf.LineQuickWizardStepSet_default) : void {
      def.onEnter(job, policyPeriod, jobWizardHelper, openForEdit)
    }
    
    // 'def' attribute on WizardStepSetRef at QuickSubmissionWizard.pcf: line 67, column 29
    function def_refreshVariables_10 (def :  pcf.LineQuickWizardStepSet_default) : void {
      def.refreshVariables(job, policyPeriod, jobWizardHelper, openForEdit)
    }
    
    // 'def' attribute on WizardStepSetRef at QuickSubmissionWizard.pcf: line 77, column 77
    function def_refreshVariables_17 (def :  pcf.JobWizardToolsMenuWizardStepSet) : void {
      def.refreshVariables(jobWizardHelper, policyPeriod)
    }
    
    // 'def' attribute on WizardStepSetRef at QuickSubmissionWizard.pcf: line 67, column 29
    function def_refreshVariables_8 (def :  pcf.LineQuickWizardStepSet_PersonalAuto) : void {
      def.refreshVariables(job, policyPeriod, jobWizardHelper, openForEdit)
    }
    
    // 'infoBar' attribute on JobWizard (id=QuickSubmissionWizard) at QuickSubmissionWizard.pcf: line 22, column 90
    function infoBar_onEnter_22 (def :  pcf.JobWizardInfoBar) : void {
      def.onEnter(submission, policyPeriod)
    }
    
    // 'infoBar' attribute on JobWizard (id=QuickSubmissionWizard) at QuickSubmissionWizard.pcf: line 22, column 90
    function infoBar_refreshVariables_23 (def :  pcf.JobWizardInfoBar) : void {
    ...
    function initialStep_32 () : java.lang.String {
    ...
    function menuActions_onEnter_24 (def :  pcf.WizardMenuActions) : void {
      def.onEnter(jobWizardHelper,submission,policyPeriod)
    }
    
    // 'menuActions' attribute on JobWizard (id=QuickSubmissionWizard) at QuickSubmissionWizard.pcf: line 22, column 90
    function menuActions_refreshVariables_25 (def :  pcf.WizardMenuActions) : void {
      def.refreshVariables(jobWizardHelper,submission,policyPeriod)
    }
    
    // 'mode' attribute on WizardStepSetRef at QuickSubmissionWizard.pcf: line 67, column 29
    ...
    function onConcurrentDataChange_26 () : void {
      CurrentLocation.cancel(); JobForward.go(job)
    }
    
    // 'onEnter' attribute on JobWizardStep (id=ViewQuote) at QuickSubmissionWizard.pcf: line 75, column 42
    ...
    static function parent_27 (policyPeriod :  PolicyPeriod, submission :  Submission) : pcf.api.Destination {
      return pcf.JobForward.createDestination(submission)
    }
    
    // 'screen' attribute on JobWizardStep (id=ViewQuote) at QuickSubmissionWizard.pcf: line 75, column 42
    function screen_onEnter_14 (def :  pcf.QuickSubmission_QuoteScreen) : void {
      def.onEnter(policyPeriod, openForEdit, jobWizardHelper)
    }
    
    // 'screen' attribute on JobWizardStep (id=ViewQuote) at QuickSubmissionWizard.pcf: line 75, column 42
    function screen_refreshVariables_15 (def :  pcf.QuickSubmission_QuoteScreen) : void {
    ...
    function subtitle_31 () : java.lang.String {
    ...
    static function title_30 (policyPeriod :  PolicyPeriod, submission :  Submission) : java.lang.Object {
      return DisplayKey.get("Web.SubmissionWizard.Title", submission.JobNumber)
    }
    
    // 'visible' attribute on JobWizardStep (id=ViewQuote) at QuickSubmissionWizard.pcf: line 75, column 42
