...
class Job_RiskAnalysisScreenExpressions {
  ...
  public static class Job_RiskAnalysisScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function def_onEnter_101 (def :  pcf.LossHistoryTypeSelectDV) : void {
      def.onEnter(policyPeriod.Policy)
    }
    
    // 'def' attribute on InputSetRef at Job_RiskAnalysisScreen.pcf: line 165, column 61
    function def_onEnter_104 (def :  pcf.LossHistoryInputSet_att) : void {
      def.onEnter(policyPeriod)
    }
    
    // 'def' attribute on InputSetRef at Job_RiskAnalysisScreen.pcf: line 165, column 61
    function def_onEnter_106 (def :  pcf.LossHistoryInputSet_man) : void {
      def.onEnter(policyPeriod)
    }
    
    // 'def' attribute on InputSetRef at Job_RiskAnalysisScreen.pcf: line 165, column 61
    function def_onEnter_108 (def :  pcf.LossHistoryInputSet_nol) : void {
      def.onEnter(policyPeriod)
    }
    
    // 'def' attribute on PanelRef at Job_RiskAnalysisScreen.pcf: line 175, column 91
    function def_onEnter_113 (def :  pcf.MotorVehicleRecordSummary) : void {
      def.onEnter(policyPeriod)
    }
    ...
    // 'def' attribute on PanelRef at Job_RiskAnalysisScreen.pcf: line 159, column 91
    function def_refreshVariables_102 (def :  pcf.LossHistoryTypeSelectDV) : void {
      def.refreshVariables(policyPeriod.Policy)
    }
    
    // 'def' attribute on InputSetRef at Job_RiskAnalysisScreen.pcf: line 165, column 61
    function def_refreshVariables_105 (def :  pcf.LossHistoryInputSet_att) : void {
      def.refreshVariables(policyPeriod)
    }
    
    // 'def' attribute on InputSetRef at Job_RiskAnalysisScreen.pcf: line 165, column 61
    function def_refreshVariables_107 (def :  pcf.LossHistoryInputSet_man) : void {
      def.refreshVariables(policyPeriod)
    }
    
    // 'def' attribute on InputSetRef at Job_RiskAnalysisScreen.pcf: line 165, column 61
    function def_refreshVariables_109 (def :  pcf.LossHistoryInputSet_nol) : void {
      def.refreshVariables(policyPeriod)
    }
    
    // 'def' attribute on PanelRef at Job_RiskAnalysisScreen.pcf: line 175, column 91
    function def_refreshVariables_114 (def :  pcf.MotorVehicleRecordSummary) : void {
      def.refreshVariables(policyPeriod)
    }
    ...
    function mode_110 () : java.lang.Object {
  ...
  public static class ListDetailPanelExpressionsImpl extends SearchPanelExpressionsImpl {
    ...
    function def_onEnter_92 (def :  pcf.ClaimsLV) : void {
    ...
    function def_onEnter_95 (def :  pcf.ClaimDetailsCV) : void {
      def.onEnter(selectedClaim,false)
    }
    
    // 'def' attribute on PanelRef at Job_RiskAnalysisScreen.pcf: line 143, column 194
    function def_refreshVariables_93 (def :  pcf.ClaimsLV) : void {
    ...
    // 'def' attribute on PanelRef at Job_RiskAnalysisScreen.pcf: line 149, column 50
    function def_refreshVariables_96 (def :  pcf.ClaimDetailsCV) : void {
  ...
  public static class SearchPanelExpressionsImpl extends Job_RiskAnalysisScreenExpressionsImpl {
    ...
    function def_onEnter_90 (def :  pcf.SearchAndResetInputSet) : void {
      def.onEnter()
    }
    
    // 'def' attribute on InputSetRef at Job_RiskAnalysisScreen.pcf: line 136, column 51
    function def_refreshVariables_91 (def :  pcf.SearchAndResetInputSet) : void {
    ...
    function searchCriteria_98 () : gw.losshistory.ClaimSearchCriteria {
    ...
    // 'value' attribute on DateCriterionChoiceInput (id=DateRangeForClaimSearch_Input) at Job_RiskAnalysisScreen.pcf: line 132, column 52
    function value_86 () : entity.DateCriteria {
      return claimSearchCriteria.DateCriteria
    }
