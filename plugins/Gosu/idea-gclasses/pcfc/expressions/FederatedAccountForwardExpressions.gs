...
class FederatedAccountForwardExpressions {
  ...
  public static class FederatedAccountForwardExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ForwardCondition at FederatedAccountForward.pcf: line 21, column 42
    function action_1 () : void {
      pcf.AccountFileDoRetrievalForward.go( accountEntity.AccountNumber)
    }
    
    // 'action' attribute on ForwardCondition at FederatedAccountForward.pcf: line 24, column 42
    ...
    // 'condition' attribute on ForwardCondition at FederatedAccountForward.pcf: line 21, column 42
    function condition_3 () : java.lang.Boolean {
      return accountEntity != null
    }
    
    // 'condition' attribute on ForwardCondition at FederatedAccountForward.pcf: line 24, column 42
    function condition_5 () : java.lang.Boolean {
      return accountEntity == null
    }
    
    // 'initialValue' attribute on Variable at FederatedAccountForward.pcf: line 15, column 30
