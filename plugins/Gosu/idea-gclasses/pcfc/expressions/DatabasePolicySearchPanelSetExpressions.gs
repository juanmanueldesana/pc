...
class DatabasePolicySearchPanelSetExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends SearchPanelExpressionsImpl {
    ...
    function allCheckedRowsAction_177 (CheckedValues :  PolicyPeriodSummary[], CheckedValuesErrors :  java.util.Map) : void {
  ...
  public static class PolicySearchDVExpressionsImpl extends SearchPanelExpressionsImpl {
    ...
    function def_onEnter_173 (def :  pcf.SearchAndResetInputSet) : void {
      def.onEnter()
    }
    ...
    // 'def' attribute on InputSetRef at DatabasePolicySearchPanelSet.pcf: line 219, column 45
    function def_refreshVariables_174 (def :  pcf.SearchAndResetInputSet) : void {
    ...
    // 'value' attribute on DateCriterionChoiceInput (id=DateRangeForJobSearch_Input) at DatabasePolicySearchPanelSet.pcf: line 208, column 31
    function value_162 () : entity.DateCriteria {
      return searchCriteria.DateCriteria
    }
    
    // 'value' attribute on DateInput (id=AsOfDate_Input) at DatabasePolicySearchPanelSet.pcf: line 215, column 52
    function value_168 () : java.util.Date {
  ...
  public static class SearchPanelExpressionsImpl extends DatabasePolicySearchPanelSetExpressionsImpl {
    ...
    function def_onEnter_180 (def :  pcf.PolicySearch_ResultsLV_Audit) : void {
      def.onEnter(searchResult)
    }
    
    // 'def' attribute on PanelRef at DatabasePolicySearchPanelSet.pcf: line 224, column 45
    function def_onEnter_182 (def :  pcf.PolicySearch_ResultsLV_Cancellation) : void {
      def.onEnter(searchResult)
    }
    
    // 'def' attribute on PanelRef at DatabasePolicySearchPanelSet.pcf: line 224, column 45
    function def_onEnter_184 (def :  pcf.PolicySearch_ResultsLV_Issuance) : void {
      def.onEnter(searchResult)
    }
    
    // 'def' attribute on PanelRef at DatabasePolicySearchPanelSet.pcf: line 224, column 45
    function def_onEnter_186 (def :  pcf.PolicySearch_ResultsLV_Policy) : void {
      def.onEnter(searchResult)
    }
    
    // 'def' attribute on PanelRef at DatabasePolicySearchPanelSet.pcf: line 224, column 45
    function def_onEnter_188 (def :  pcf.PolicySearch_ResultsLV_PolicyChange) : void {
      def.onEnter(searchResult)
    }
    
    // 'def' attribute on PanelRef at DatabasePolicySearchPanelSet.pcf: line 224, column 45
    function def_onEnter_190 (def :  pcf.PolicySearch_ResultsLV_Reinstatement) : void {
      def.onEnter(searchResult)
    }
    
    // 'def' attribute on PanelRef at DatabasePolicySearchPanelSet.pcf: line 224, column 45
    function def_onEnter_192 (def :  pcf.PolicySearch_ResultsLV_Renewal) : void {
      def.onEnter(searchResult)
    }
    
    // 'def' attribute on PanelRef at DatabasePolicySearchPanelSet.pcf: line 224, column 45
    function def_onEnter_194 (def :  pcf.PolicySearch_ResultsLV_Rewrite) : void {
      def.onEnter(searchResult)
    }
    
    // 'def' attribute on PanelRef at DatabasePolicySearchPanelSet.pcf: line 224, column 45
    function def_onEnter_196 (def :  pcf.PolicySearch_ResultsLV_RewriteNewAccount) : void {
      def.onEnter(searchResult)
    }
    
    // 'def' attribute on PanelRef at DatabasePolicySearchPanelSet.pcf: line 224, column 45
    function def_onEnter_198 (def :  pcf.PolicySearch_ResultsLV_Submission) : void {
      def.onEnter(searchResult)
    }
    
    // 'def' attribute on PanelRef at DatabasePolicySearchPanelSet.pcf: line 224, column 45
    function def_refreshVariables_181 (def :  pcf.PolicySearch_ResultsLV_Audit) : void {
      def.refreshVariables(searchResult)
    }
    
    // 'def' attribute on PanelRef at DatabasePolicySearchPanelSet.pcf: line 224, column 45
    function def_refreshVariables_183 (def :  pcf.PolicySearch_ResultsLV_Cancellation) : void {
      def.refreshVariables(searchResult)
    }
    
    // 'def' attribute on PanelRef at DatabasePolicySearchPanelSet.pcf: line 224, column 45
    function def_refreshVariables_185 (def :  pcf.PolicySearch_ResultsLV_Issuance) : void {
      def.refreshVariables(searchResult)
    }
    
    // 'def' attribute on PanelRef at DatabasePolicySearchPanelSet.pcf: line 224, column 45
    function def_refreshVariables_187 (def :  pcf.PolicySearch_ResultsLV_Policy) : void {
      def.refreshVariables(searchResult)
    }
    
    // 'def' attribute on PanelRef at DatabasePolicySearchPanelSet.pcf: line 224, column 45
    function def_refreshVariables_189 (def :  pcf.PolicySearch_ResultsLV_PolicyChange) : void {
      def.refreshVariables(searchResult)
    }
    
    // 'def' attribute on PanelRef at DatabasePolicySearchPanelSet.pcf: line 224, column 45
    function def_refreshVariables_191 (def :  pcf.PolicySearch_ResultsLV_Reinstatement) : void {
      def.refreshVariables(searchResult)
    }
    
    // 'def' attribute on PanelRef at DatabasePolicySearchPanelSet.pcf: line 224, column 45
    function def_refreshVariables_193 (def :  pcf.PolicySearch_ResultsLV_Renewal) : void {
      def.refreshVariables(searchResult)
    }
    
    // 'def' attribute on PanelRef at DatabasePolicySearchPanelSet.pcf: line 224, column 45
    function def_refreshVariables_195 (def :  pcf.PolicySearch_ResultsLV_Rewrite) : void {
      def.refreshVariables(searchResult)
    }
    
    // 'def' attribute on PanelRef at DatabasePolicySearchPanelSet.pcf: line 224, column 45
    function def_refreshVariables_197 (def :  pcf.PolicySearch_ResultsLV_RewriteNewAccount) : void {
      def.refreshVariables(searchResult)
    }
    
    // 'def' attribute on PanelRef at DatabasePolicySearchPanelSet.pcf: line 224, column 45
    function def_refreshVariables_199 (def :  pcf.PolicySearch_ResultsLV_Submission) : void {
      def.refreshVariables(searchResult)
    }
    
    // 'maxSearchResults' attribute on SearchPanel at DatabasePolicySearchPanelSet.pcf: line 16, column 87
    function maxSearchResults_201 () : java.lang.Object {
    ...
    function mode_200 () : java.lang.Object {
    ...
    function searchCriteria_203 () : gw.policy.PolicyPeriodSearchCriteria {
    ...
    function search_202 () : java.lang.Object {
    ...
    function value_178 () : typekey.UserRole[] {
