...
class FederatedActivityForwardExpressions {
  ...
  public static class FederatedActivityForwardExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    static function __constructorIndex (activityPublicId :  java.lang.String, accountPublicId :  java.lang.String) : int {
      return 0
    }
    
    // 'action' attribute on ForwardCondition at FederatedActivityForward.pcf: line 21, column 41
    function action_1 () : void {
      ActivityForward.go(activityEntity, activityEntity.PolicyPeriod)
    }
    
    // 'action' attribute on ForwardCondition at FederatedActivityForward.pcf: line 24, column 41
    function action_4 () : void {
      gw.api.web.desktop.data.ResolverRedirectHelper.activityForward(accountPublicId, activityPublicId)
    }
    ...
    // 'condition' attribute on ForwardCondition at FederatedActivityForward.pcf: line 21, column 41
    function condition_3 () : java.lang.Boolean {
      return activityEntity!=null
    }
    
    // 'condition' attribute on ForwardCondition at FederatedActivityForward.pcf: line 24, column 41
    function condition_5 () : java.lang.Boolean {
      return activityEntity==null
    }
    
    // 'initialValue' attribute on Variable at FederatedActivityForward.pcf: line 15, column 31
