...
class UserPreferencesContactInputSetExpressions {
  ...
  public static class UserPreferencesContactInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function def_onEnter_10 (def :  pcf.GlobalAddressInputSet_PE) : void {
    ...
    // 'def' attribute on InputSetRef (id=UserAddress) at UserPreferencesContactInputSet.pcf: line 28, column 30
    function def_onEnter_14 (def :  pcf.GlobalAddressInputSet_PostCodeBeforeCityState) : void {
      def.onEnter(addressOwner)
    }
    ...
    // 'def' attribute on InputSetRef (id=UserAddress) at UserPreferencesContactInputSet.pcf: line 28, column 30
    function def_refreshVariables_11 (def :  pcf.GlobalAddressInputSet_PE) : void {
    ...
    // 'def' attribute on InputSetRef (id=UserAddress) at UserPreferencesContactInputSet.pcf: line 28, column 30
    function def_refreshVariables_15 (def :  pcf.GlobalAddressInputSet_PostCodeBeforeCityState) : void {
      def.refreshVariables(addressOwner)
    }
