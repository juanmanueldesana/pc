...
class InternalToolsTabBarExpressions {
  ...
  public static class InternalToolsTabBarExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function systemAlertBar_onEnter_135 (def :  pcf.SystemAlertBar) : void {
      def.onEnter()
    }
    
    // 'systemAlertBar' attribute on TabBar (id=InternalToolsTabBar) at InternalToolsTabBar.pcf: line 7, column 39
    function systemAlertBar_refreshVariables_136 (def :  pcf.SystemAlertBar) : void {
  ...
  public static class LocationGroupMenuItemExpressionsImpl extends ServerToolsTabMenuItemExpressionsImpl {
    ...
    // 'location' attribute on Tab (id=ServerToolsTab) at InfoPages.pcf: line 59, column 40
    function action_40 () : void {
      pcf.PostgreSQLPerfInfo.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at InfoPages.pcf: line 62, column 37
    function action_42 () : void {
      pcf.LoadHistoryInfo.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at InfoPages.pcf: line 65, column 41
    function action_44 () : void {
      pcf.LoadIntegrityChecks.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at InfoPages.pcf: line 68, column 36
    function action_46 () : void {
      pcf.LoadErrorsInfo.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at InfoPages.pcf: line 71, column 44
    function action_48 () : void {
      pcf.RuntimeEnvironmentInfo.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at InfoPages.pcf: line 74, column 45
    function action_50 () : void {
      pcf.SafePersistingOrderInfo.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at InfoPages.pcf: line 77, column 39
    function action_52 () : void {
      pcf.LoadedGosuClasses.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at InfoPages.pcf: line 79, column 39
  ...
  public static class UnsupportedToolsTabMenuItemExpressionsImpl extends InternalToolsTabBarExpressionsImpl {
    ...
    // 'location' attribute on Tab (id=UnsupportedToolsTab) at UnsupportedTools.pcf: line 28, column 48
    function action_126 () : void {
      pcf.NPGNewProductGenerator_acc.go()
    }
