...
class InfoPagesExpressions {
  ...
  public static class InfoPagesExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'location' attribute on LocationGroup (id=InfoPages) at InfoPages.pcf: line 59, column 40
    function action_30 () : void {
      pcf.PostgreSQLPerfInfo.go()
    }
    
    // 'location' attribute on LocationGroup (id=InfoPages) at InfoPages.pcf: line 62, column 37
    function action_32 () : void {
      pcf.LoadHistoryInfo.go()
    }
    
    // 'location' attribute on LocationGroup (id=InfoPages) at InfoPages.pcf: line 65, column 41
    function action_34 () : void {
      pcf.LoadIntegrityChecks.go()
    }
    
    // 'location' attribute on LocationGroup (id=InfoPages) at InfoPages.pcf: line 68, column 36
    function action_36 () : void {
      pcf.LoadErrorsInfo.go()
    }
    
    // 'location' attribute on LocationGroup (id=InfoPages) at InfoPages.pcf: line 71, column 44
    ...
    // 'location' attribute on LocationGroup (id=InfoPages) at InfoPages.pcf: line 74, column 45
    function action_40 () : void {
      pcf.SafePersistingOrderInfo.go()
    }
    
    // 'location' attribute on LocationGroup (id=InfoPages) at InfoPages.pcf: line 77, column 39
    function action_42 () : void {
      pcf.LoadedGosuClasses.go()
    }
    
    // 'location' attribute on LocationGroup (id=InfoPages) at InfoPages.pcf: line 79, column 39
