...
class UnsupportedToolsExpressions {
  ...
  public static class UnsupportedToolsExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'location' attribute on LocationGroup (id=UnsupportedTools) at UnsupportedTools.pcf: line 28, column 48
    ...
    static function firstVisitableChildDestinationMethod_23 () : pcf.api.Destination {
      ...
      dest = pcf.NPGNewProductGenerator_acc.createDestination()
      if (dest.canVisitSelf()) {
        return dest
      }
      return null
    ...
    function menuActions_onEnter_19 (def :  pcf.InternalToolsMenuActions) : void {
      def.onEnter()
    }
    
    // 'menuActions' attribute on LocationGroup (id=UnsupportedTools) at UnsupportedTools.pcf: line 10, column 26
    function menuActions_refreshVariables_20 (def :  pcf.InternalToolsMenuActions) : void {
      def.refreshVariables()
    }
    
    // 'tabBar' attribute on LocationGroup (id=UnsupportedTools) at UnsupportedTools.pcf: line 10, column 26
    function tabBar_onEnter_21 (def :  pcf.InternalToolsTabBar) : void {
      def.onEnter()
    }
    
    // 'tabBar' attribute on LocationGroup (id=UnsupportedTools) at UnsupportedTools.pcf: line 10, column 26
    function tabBar_refreshVariables_22 (def :  pcf.InternalToolsTabBar) : void {
      def.refreshVariables()
    }
