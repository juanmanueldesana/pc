...
public class DesktopActivitiesLV extends com.guidewire.pl.web.codegen.SectionBase {
  function onEnter () : void {
    __widgetOf(this, pcf.DesktopActivitiesLV, SECTION_WIDGET_CLASS).setVariables(false, {})
  }
  
  function refreshVariables () : void {
    __widgetOf(this, pcf.DesktopActivitiesLV, SECTION_WIDGET_CLASS).setVariables(true, {})
  }
