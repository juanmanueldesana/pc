...
class JobWizardInfoBarExpressions {
  ...
  public static class JobWizardInfoBarExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'icon' attribute on InfoBarElement (id=LOBLabel) at JobWizardInfoBar.pcf: line 28, column 44
    ...
    // 'label' attribute on InfoBarElement (id=LOBLabel) at JobWizardInfoBar.pcf: line 28, column 44
