...
abstract class JobProcess implements gw.job.IJobProcess {
  ...
  private final var _ilIdentifier: ILElementIdentifier as ILIdentifier = JobILElementSource.ABSTRACT_JOB_PROCESS

  private final var _intentionalLogger: JobProcessIntentionalLogger as IntentionalLogger = JobProcessIntentionalLogger.MUTED
  ...
  private function startJobWithStatus(status: PolicyPeriodStatus) {
    ...
    IntentionalLogger.logStart(ILIdentifier)
